...
Rectangle {
    ...
    Rectangle {
        ...
        Column {
            ...
            Text { text: "SOLAR FORGE  /  DAILY SYSTEM BRIEF"; color: theme.accentColor; font.family: Style.font.menuFamily; font.pixelSize: 12; font.bold: true; font.letterSpacing: 1.7 }
            ...
            GridLayout {
                width: parent.width; columns: width < 620 ? 2 : 4; rowSpacing: 10; columnSpacing: 9; opacity: root.stage; Behavior on opacity { NumberAnimation { duration: 420 } }
                Repeater { model: [
                    ...
                    Column { anchors.fill: parent; anchors.margins: 11; spacing: 7
                        Text { text: modelData.label; color: theme.faintTextColor; font.family: Style.font.menuFamily; font.pixelSize: 12; font.bold: true; font.letterSpacing: 1 }
            ...
            RowLayout { width: parent.width; opacity: root.stage; Behavior on opacity { NumberAnimation { duration: 420 } }
                Column { Layout.fillWidth: true; spacing: 3
                    Text { width: parent.width; wrapMode: Text.Wrap; text: "GPU  /  " + source.gpu; color: theme.foregroundColor; font.family: Style.font.menuFamily; font.pixelSize: 12; font.bold: true }
                    Text { width: parent.width; wrapMode: Text.Wrap; text: source.gpuDetail + "  ·  " + objectiveCount + " active objectives  ·  " + missionSource.repositories.length + " GitHub repositories synced"; color: theme.dimmedTextColor; font.family: Style.font.menuFamily; font.pixelSize: 12 }
                }
            }
            Rectangle { width: parent.width; height: 54; radius: 6; color: Util.alpha(theme.accentColor, 0.09); border.color: Util.alpha(theme.accentColor, 0.32)
                RowLayout { anchors.fill: parent; anchors.margins: 12
                    Text { text: "RECOMMENDATION"; color: theme.accentColor; font.family: Style.font.menuFamily; font.pixelSize: 12; font.bold: true; font.letterSpacing: 1 }
                    Text { Layout.fillWidth: true; wrapMode: Text.Wrap; text: source.recommendation; color: theme.foregroundColor; font.family: Style.font.menuFamily; font.pixelSize: 12 }
                }
            }
            RowLayout { width: parent.width; Item { Layout.fillWidth: true }
                Rectangle { implicitWidth: 166; implicitHeight: 32; radius: 16; color: theme.accentColor
                    Text { anchors.centerIn: parent; text: "ENTER  ·  CONTINUE"; color: theme.backgroundColor; font.family: Style.font.menuFamily; font.pixelSize: 12; font.bold: true }
